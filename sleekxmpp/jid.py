...
JID_CACHE_MAX_SIZE = 102400 #default = 1024
...
def _validate_node(node):  #### !!!!!!!!! UNCOMMENT try:!!!!
    ...
    if node is not None:
        ...
        if len(node) > 10250:#default = 1023
...
def _validate_domain(domain):
    ...
    if not ip_addr:
        ...
        for label in domain.split('.'):
            ...
            # if not pass_nameprep:  UNCOMMENT!!!!
            ...
            # if '-' in (label[0], label[-1]):  UNCOMMENT!!!!
    ...
    if len(domain) > 10250:#default = 1023
...
def _validate_resource(resource):
    ...
    try:
        if resource is not None:
            ...
            if len(resource) > 10250:#default = 1023
